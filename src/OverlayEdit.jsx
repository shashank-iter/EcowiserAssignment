...
export default function OverlayEdit(props) {
  const [open, setOpen] = useState(false);

const {data , note_id} = props.props;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data, error } = await supabase
        .from("notes")
        .update({ note_id: note_id, data: formData })
        .eq("note_id", note_id)
        .select();
      ...
      swal({
        title: "Error!",
        text: "There was some error in updating the note. Please try again!",
        icon: "error",
        button: "OK",
      });
    } finally {
                          ...
                          <div className="flex items-start justify-between space-x-3">
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-gray-500">
                                You can start editing your note by editing the
                                content in fields given below.
                              </p>
                            </div>
